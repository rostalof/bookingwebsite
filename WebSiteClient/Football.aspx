...
<head id="Head1" runat="server">
    <title>GAA Packages Football</title>
...
&nbsp;&nbsp; <asp:Label ID="Label2" runat="server" Text="Game"></asp:Label>
                    <asp:DropDownList ID="ddlGames" runat="server" CssClass="ddl" AutoPostBack="True" OnSelectedIndexChanged="ddlGames_SelectedIndexChanged">
                        <asp:ListItem Value="1">SFC Quarter Final 1</asp:ListItem>
                    <asp:ListItem Value="2">SFC Quarter Final 2</asp:ListItem>
                    <asp:ListItem Value="3">SFC Quarter Final 3</asp:ListItem>
                    <asp:ListItem Value="4">SFC Quarter Final 4</asp:ListItem>
                    <asp:ListItem Value="5">SFC Semi Final 1</asp:ListItem>
                    <asp:ListItem Value="6">SFC Semi Final 2</asp:ListItem>
                    <asp:ListItem Value="7">SFC All Ireland Final</asp:ListItem>
                </asp:DropDownList>
